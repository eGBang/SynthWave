 ...
 * This file demonstrates how to integrate Synthwave with a web frontend
 */

// For React/Vue/Angular applications
export class SynthwaveClient {
    ...
    useEffect(() => {
        async function init() {
            try {
                ...
                const contractClient = new SynthwaveClient(provider, contractAddress);
